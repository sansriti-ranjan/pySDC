...
class Strategy:
    ...
    def __init__(self, useMPI=False, skip_residual_computation="none"):
        ...
        self.custom_description["sweeper_params"] = {
            "skip_residual_computation": self.skip_residual_computation
        }
...
class BaseStrategy(Strategy):
    ...
    def __init__(self, useMPI=False, skip_residual_computation="all"):
        ...
        """
        super().__init__(
            useMPI=useMPI, skip_residual_computation=skip_residual_computation
        )
        self.color = list(cmap.values())[0]
        self.marker = "o"
        self.name = "base"
...
class AdaptivityStrategy(Strategy):
    ...
    def get_custom_description(self, problem, num_procs):
        ...
        if problem.__name__ == "run_piline":
            ...
            custom_description["convergence_controllers"][
                BasicRestarting.get_implementation(flavor)
            ] = {"max_restarts": 15}
        else:
 ...
 strategy"
        ...
        return merge_descriptions(
            super().get_custom_description(problem, num_procs), custom_description
        )
...
class AdaptivityCollocationStrategy(Strategy):
 ...
 strategy"
        ...
        custom_description["level_params"] = {
            "restol": e_tol / 10 if self.restol is None else self.restol
        }
        custom_description["convergence_controllers"] = {
            AdaptivityCollocation: {
                "e_tol": e_tol,
...
class DoubleAdaptivityStrategy(AdaptivityStrategy):
    ...
    def get_custom_description(self, problem, num_procs):
        ...
        if self.residual_e_tol_abs:
            ...
            e_tol = (
                custom_description["convergence_controllers"][Adaptivity]["e_tol"]
                * self.residual_e_tol_ratio
            )
