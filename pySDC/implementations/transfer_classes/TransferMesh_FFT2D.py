...
class mesh_to_mesh_fft2d(space_transfer):
    ...
    def prolong(self, G):
        ...
        if isinstance(G, mesh):
            ...
            tmpF[
                self.fine_prob.init[0][0] - halfG :, self.fine_prob.init[0][0] - halfG :
            ] = tmpG[halfG:, halfG:]
            ...
            tmpF_impl[self.fine_prob.init[0][0] - halfG :, 0:halfG] = tmpG_impl[
                halfG:, 0:halfG
            ]
            tmpF_impl[0:halfG, self.fine_prob.init[0][0] - halfG :] = tmpG_impl[
                0:halfG, halfG:
            ]
            tmpF_impl[
                self.fine_prob.init[0][0] - halfG :, self.fine_prob.init[0][0] - halfG :
            ...
            tmpF_expl[self.fine_prob.init[0][0] - halfG :, 0:halfG] = tmpG_expl[
                halfG:, 0:halfG
            ]
            tmpF_expl[0:halfG, self.fine_prob.init[0][0] - halfG :] = tmpG_expl[
                0:halfG, halfG:
            ]
            tmpF_expl[
                self.fine_prob.init[0][0] - halfG :, self.fine_prob.init[0][0] - halfG :
