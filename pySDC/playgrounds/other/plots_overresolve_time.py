...
def plot_data():
    ...
    speedup_overres = [
        p / (p * alpha_overres + k * (1 + alpha_overres))
    ...
    plt_helper.plt.semilogx(
        ...
        marker="o",
        markersize=6,
        label=r"$N_\mathcal{F}=1024, \alpha=\frac{1}{32}$",
    )
    ...
    speedup_wellres_1 = [
        p / (p * alpha_wellres_1 + k * (1 + alpha_wellres_1))
    ...
    speedup_wellres_2 = [
        p / (p * alpha_wellres_2 + k * (1 + alpha_wellres_2))
    ...
    plt_helper.plt.semilogx(
        ...
        marker="d",
        markersize=6,
        label=r"$N_\mathcal{F}=32, \alpha=\frac{1}{32}$",
    )
    plt_helper.plt.semilogx(
        nprocs,
        speedup_wellres_2,
        ...
        marker="s",
        markersize=6,
        label=r"$N_\mathcal{F}=32, \alpha=\frac{1}{4}$",
    )
