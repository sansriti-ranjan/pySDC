...
def main(dt, Tend):
    ...
    controller_params[
        "hook_class"
    ] = particles_output  # specialized hook class for more statistics and output
...
def plot_error_and_positions(uinit, stats, a0):
    ...
    plt.savefig(
        "spiraling_particle_error_ham.png", transparent=True, bbox_inches="tight"
    )
    ...
    plt.savefig(
        "spiraling_particle_positons.png", transparent=True, bbox_inches="tight"
    )
