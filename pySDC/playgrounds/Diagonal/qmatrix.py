...
OPT_COEFFS = {
    "QmQd": {
        2: {
            "GAUSS": [(0.105662, 0.394338), (0.394338, 0.105662)],
            "RADAU-LEFT": [(0.0, 0.333333)],
            "RADAU-RIGHT": [(0.166667, 0.5), (0.666667, 0.0)],
            "LOBATTO": [(0.0, 0.5)],
        },
        3: {
            "GAUSS": [
            ...
            "LOBATTO": [(0.0, 0.166667, 0.333333), (0.0, 0.5, 0.0)],
        },
        5: {
            "RADAU-RIGHT": [
    ...
    "Speck": {
        2: {
            "GAUSS": [(0.166667, 0.5), (0.5, 0.166667)],
            "RADAU-LEFT": [(0.0, 0.333333)],
            "RADAU-RIGHT": [(0.258418, 0.644949), (1.074915, 0.155051)],
            "LOBATTO": [(0.0, 0.5)],
        },
        3: {
            "GAUSS": [
            ...
            "LOBATTO": [(0.0, 0.211325, 0.394338), (0.0, 0.788675, 0.105662)],
        },
    },
}
...
WEIRD_COEFFS = {
    "GAUSS": {2: (0.5, 0.5)},
    "RADAU-RIGHT": {2: (0.5, 0.5)},
    "RADAU-LEFT": {3: (0.0, 0.5, 0.5)},
    "LOBATTO": {3: (0.0, 0.5, 0.5)},
}
...
def genQDelta(nodes, sweepType, Q):
    ...
    if sweepType in ["BE", "FE"]:
        ...
        try:
            ...
            raise ValueError(
                "no OPT diagonal coefficients for " f"{oType}-{M}-{quadType}-{idx}"
            )
        ...
        try:
            ...
            raise ValueError(
                "no WEIRD diagonal coefficients for " f"{M}-{quadType} nodes"
            )
    else:
