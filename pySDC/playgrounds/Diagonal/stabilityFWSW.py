...
def plotStabContour(
    ...
    CS2 = ax.contour(lamSlow.imag, lamFast.imag, stab, levels=[1.0], colors="black")
    ...
    plt.gcf().suptitle(
        f"Q={qType}-{M}, QI={implSweep}, QE={explSweep}, "
        f"forceProl={forceProl}, initSweep={initSweep}",
        y=0.95,
    )
